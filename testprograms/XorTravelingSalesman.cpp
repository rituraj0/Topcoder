...
int maxProfit(vector <int> cityValues, vector <string> _road) 
{
    value=cityValues;
    road=_road;
    n=road.size();
...
double test3() {
	int t0[] = {37, 1, 19, 64, 42, 41, 64, 64, 54, 16, 256, 36, 64, 2, 4, 2, 62, 29, 58, 64, 1, 32, 16,
 256, 17, 2, 17, 4, 1, 64, 21, 8, 256, 63, 3, 1, 43, 15, 8, 39, 41, 8, 16, 8, 16, 256, 64, 512, 45, 64};
	vector <int> p0(t0, t0+sizeof(t0)/sizeof(int));
	string t1[] = {"NNNNNNYYYYNNNNNNNNNNNNNNNNNNNNNNNNNYNNNNNNNNNNNNNN",
